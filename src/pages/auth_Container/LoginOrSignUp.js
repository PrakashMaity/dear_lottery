...
export default function LoginOrSignUp() {
    ...
    const [whichBox, setWhichBox] = useState("login")
    ...
    return (
        <View style={[styles.mainContainer, { backgroundColor: Colors.background_shade, }]} >
            ...
            <View style={{ flex: 1.5, alignItems: "center", justifyContent: "center" }} >
                <View style={{ height: "85%", width: "78%", borderRadius: Normalize(20), overflow: "hidden", elevation: Normalize(1), backgroundColor: Colors.white, justifyContent: "center", alignItems: "center" }} >
                    <Image source={images.soldout} style={{ height: "90%", width: "90%", resizeMode: "cover" }} />
                </View>
            </View>
            <View style={{ flex: 1, alignItems: "center" }} >
                <Text style={{ fontFamily: "Outfit-SemiBold", fontSize: Normalize(20), color: Colors.purple, paddingTop: Normalize(20) }} >What do you want to do here?</Text>
                ...
                <View style={{ height: Normalize(38), width: "78%", alignSelf: "center", marginTop: Normalize(20), flexDirection: "row", justifyContent: "space-between" }}  >
                    <TouchableOpacity
