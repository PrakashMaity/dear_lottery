    ...
    <View style={[globalStyles.mainContainer_withoutpadding]}>
      ...
      >
        ...
        <Text
          style={[
            ...
            { fontSize: Normalize(13), paddingTop: Normalize(3) },
          ]}
        >
          Total Earn :{' '}
          <Text style={{ fontSize: Normalize(12) }}>
            {few_constants.rupee} {addComma(0)}
          </Text>
        </Text>
        ...
        <TouchableOpacity
          onPress={() =>
            Linking.openURL(
              'whatsapp://send?text=Hello Gita Lottery ,can we talk now!&phone=+919733745549'
            )
          }
          style={{
            height: Normalize(25),
      ...
      <View style={{ flex: 1 }}>
        <View style={{}}>
          ...
          <TouchableOpacity onPress={onpresssLogout} style={styles.eachBox}>
            <View style={styles.eachIconBox}>
              <MaterialCommunityIcons
                name={'logout'}
                color={Colors.purple}
